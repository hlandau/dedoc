...
method_txt-mandoc-mdoc-xsl1_all: $(METHOD_TXT_MANDOC_MDOC_XSL1_TARGETS_EXPR) $(METHOD_PS_MANDOC_MDOC_XSL1_TARGETS_EXPR) $(METHOD_PDF_MANDOC_MDOC_XSL1_TARGETS_EXPR) $(METHOD_XHTML_MANDOC_MDOC_XSL1_TARGETS_EXPR)
	$(Q)true

$(METHOD_TXT_MANDOC_MDOC_XSL1_OUT_DIR)/%.txt: $(METHOD_MDOC_XSL1_OUT_DIR)/%
	$(call INFO,MANDOC,$@)
